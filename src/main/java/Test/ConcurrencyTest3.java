    ...
    public static void main(String[] args) {
        ...
        for(int i = 0;i < 3;i++){
            if(i%3==0) {
                ...
                NonTxWorker worker3 = new NonTxWorker(TestUtil.createLog("/Users/bhushan/Documents/UCI/Transaction/project/Logging-System/schema/text1.txt", CONSTANTS.LOG_TYPE_TEXT), loggingSystem);
